...
func (self *UdpService)  Start()  {


		listen ,err:= net.ListenUDP("udp",self.Addr)
...
func (self *UdpService) CountSession() int  {
       return  len(self.SessionList)
}
func  (self *UdpService) GetList()   {
...
func (self*UdpService) ShowMsg(sessionId ,params  string)  {
...
func (self*UdpService)  Send( sessionId , val string)  error {
...
func createSession( addr *net.UDPAddr ,conn *net.UDPConn) ISession  {
